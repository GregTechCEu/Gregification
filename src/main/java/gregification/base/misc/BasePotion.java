package gregification.base.misc;
...
public abstract class BasePotion extends Potion {
    ...
    private static final ResourceLocation resource = new ResourceLocation(Gregification.MODID, "textures/gui/potions.png");
    private final int iconIndex;

    public BasePotion(String name, boolean badEffect, int color, int iconIndex) {
        super(badEffect, color);
        setRegistryName(new ResourceLocation(Gregification.MODID + ".potion." + name));
        setPotionName(Gregification.MODID + ".potion." + name);
